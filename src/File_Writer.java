...
public class File_Writer extends Input {
    ...
    public static void writeInverse(double[][] m, String hasil, double[][] invM, boolean adaBalikan, boolean kofaktor, double[][] m1, double[][] m2) {
        /* 
         ...
         * - (kofaktor) bernilai true jika metode yang digunakan adalah ekspansi kofaktor
         * - (m1) adalah matriks kofaktornya jika kofaktor, m Awal gabung jika bukan menggunakan metode kofaktor
         * - (m2) adalah matriks adjointnya jika kofaktor, m Akhir gabung jika bukan menggunakan metode kofaktor
         */
