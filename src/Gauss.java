...
public class Gauss {
    ...
    public static double[][] gauss (double[][] m){
        ...
        for (int k = 0 ; k < endState ; k++){
            ...
            while (Primitive.colNol(m, pivotCol) && (pivotCol < col)) {
                ...
                // Tetapi jika nilai (pivotCol) sudah sama dengan (col), tidak perlu melompati lagi
    ...
    public static double[][] bagiRow (double[][] m, int pivotCol, int i, Double X){
        /* Menerima matriks (m), kolom dimulai (pivotCol), baris ke (i), dan konstanta (X)
    ...
    public static double[][] elimRow (double[][] m, int i, int pivotCol, int k){
        /* Menerima matriks (m), baris (i), kolom (pivotCol), dan baris yang menjadi pusat sementara (k)
